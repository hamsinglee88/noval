/// 风格分析模块
///
/// 包含词汇层、句式层、修辞层、叙事层、情感层、节奏层、对话层、描写层等特征分析功能
...
pub use dialogue_analysis::{extract_dialogue_features, extract_dialogue_features_chunked, DialogueAnalysisResult};
pub use description_analysis::{extract_description_features, extract_description_features_chunked, DescriptionAnalysisResult};
