...
pub fn create_router(state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/api/style-profiles/{id}", delete(style_profiles::delete_style_profile))
        ...
        .route("/api/projects/{novel_id}/chapters", get(chapters::list_chapters))
        .route("/api/projects/{novel_id}/chapters", post(chapters::create_chapter))
